...
test('Test transaction (begin)', () => {
    ...
    expect(dbapi.getWorkingDB()).toMatchObject({		// Check transaction state
	'david': 'chang',
	'diana': 'chang',
	'ben': 'chang',
	'hannah': 'chang',
...
test('Test transaction (rollback)', () => {
    ...
    expect(dbapi.getWorkingDB()).toMatchObject({		// Make sure that the transaction state matches the database save state again
	'david': 'chang',
	'diana': 'sim',
	'ben': 'chang',
	'hannah': 'chang',
